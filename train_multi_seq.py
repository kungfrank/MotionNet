...
#        print(all_valid_pixel_maps.shape) # no need for radar
#        print(non_empty_map.shape) # no need for radar
#        print(pixel_cat_map_gt.shape)
#        print(trans_matrices.shape)
#        print(motion_gt.shape)
#        print(pixel_instance_map.shape)
#        print(num_past_frames)
#        print(num_future_frames)
#        torch.Size([bs, 2, 5, 256, 256, 13])
#        torch.Size([bs, 2, 20, 256, 256, 2])
#        torch.Size([bs, 2, 20, 256, 256])
#        torch.Size([bs, 2, 256, 256])
#        torch.Size([bs, 2, 256, 256, 5])
#        torch.Size([bs, 2, 30, 4, 4])
#        torch.Size([bs, 2, 256, 256, 2])
#        torch.Size([bs, 2, 256, 256])
#        tensor([5, 5]) # len = bs
#        tensor([20, 20]) # len = bs
...
#        print('---network input--- \n',padded_voxel_points.shape)
        #input shape: torch.Size([bs*2, 5, 256, 256, 13])
...
def compute_and_bp_loss(optimizer, device, future_frames_num, all_disp_field_gt, all_valid_pixel_maps, pixel_cat_map_gt,
    ...
    all_disp_field_gt = all_disp_field_gt.view(-1, future_frames_num, 256, 256, 2) # [1, 20*bs, 256, 256, 2]
    gt = all_disp_field_gt[:, -future_frames_num:, ...].contiguous() # [1, 20*bs, 256, 256, 2]
    gt = gt.view(-1, gt.size(2), gt.size(3), gt.size(4)) # [20*bs, 256, 256, 2]
    gt = gt.permute(0, 3, 1, 2).to(device) # [20*bs, 2, 256, 256]
    ...
    print('non_empty_map', non_empty_map.shape)
    #print(pixel_cat_map_gt.shape) # torch.Size([2, 256, 256, 5])
    pixel_cat_map_gt = pixel_cat_map_gt.permute(0, 3, 1, 2).to(device)
    #print(pixel_cat_map_gt.shape) # torch.Size([2, 5, 256, 256])
    #print(class_pred.shape) # torch.Size([2, 5, 256, 256])
    ...
    print('loss_class.shape', loss_class.shape)
