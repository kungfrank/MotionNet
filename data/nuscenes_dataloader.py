...
class TrainDatasetMultiSeq(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        if idx in self.cache:
            ...
            #print('idx in self.cache', gt_dict_list)
        else:
            #print('else')
        ...
        for gt_dict in gt_dict_list:
            ...
            dims = gt_dict['3d_dimension']  # --> (256, 256, 13)
            num_future_pcs = gt_dict['num_future_pcs'] # 20 # number of future frames
            pixel_indices = gt_dict['pixel_indices'] # (N, 2) # (occupacy, position)
            trans_matrices = gt_dict['trans_matrices'] # (30, 4, 4) # gt ego-motion of this sequence 25 = 5(past+current) + 20(future)

            sparse_disp_field_gt = gt_dict['disp_field'] # (20, N, 2)
            ...
            sparse_valid_pixel_maps = gt_dict['valid_pixel_map'] # (20, N)
            ...
            sparse_pixel_cat_maps = gt_dict['pixel_cat_map'] # (N, 5)
            ...
            sparse_pixel_instance_maps = gt_dict['pixel_instance_ids'] # (N,)
            ...
            non_empty_map = np.zeros((dims[0], dims[1]), dtype=np.float32) # (256, 256) # 2d non_empty_map
            non_empty_map[pixel_indices[:, 0], pixel_indices[:, 1]] = 1.0

#            print('=========================================')
#            print(dims)
#            print(num_future_pcs)
#            print(pixel_indices.shape)
#            print(trans_matrices.shape)
#            print(sparse_disp_field_gt.shape)
#            print(sparse_valid_pixel_maps.shape)
#            print(sparse_pixel_cat_maps.shape)
#            print(sparse_pixel_instance_maps.shape)
#            print(non_empty_map.shape)
            ...
            padded_voxel_points_list.append(padded_voxel_points[-5:]) # (5, 256, 256, 13) # (t,x,y,height)
            all_disp_field_gt_list.append(all_disp_field_gt) # (20, 256, 256, 2) # velocity_map * 20
            all_valid_pixel_maps_list.append(all_valid_pixel_maps) # (20, 256, 256) # non_empty_map * 20 (used for loss computation)
            non_empty_map_list.append(non_empty_map) # (256, 256)
            pixel_cat_map_list.append(pixel_cat_map) # (256, 256, 5)
            trans_matrices_list.append(trans_matrices) # (30, 4, 4)
            pixel_instance_map_list.append(pixel_instance_map) # (256, 256) # item ID of each pixel(used for loss computation)

            print('--------------------------------------')
            print(padded_voxel_points.shape)
            print(padded_voxel_points[-5:].shape)
            print(len(padded_voxel_points_list))
#            print(all_disp_field_gt.shape)
#            print(all_valid_pixel_maps.shape)
#            print(non_empty_map.shape)
#            print(pixel_cat_map.shape)
#            print(trans_matrices.shape)
#            print(pixel_instance_map.shape)
...
#        plt.figure(1)
#        plt.imshow(padded_voxel_points[-1,:,:,6])
#        plt.figure(2)
#        plt.imshow(padded_voxel_points[-3,:,:,6])
#        plt.figure(3)
...
#        print('----list----')
#        print(padded_voxel_points_list.shape)
#        print(all_disp_field_gt_list.shape)
#        print(all_valid_pixel_maps_list.shape)
#        print(non_empty_map_list.shape)
#        print(pixel_cat_map_list.shape)
#        print(trans_matrices_list.shape)
#        print(pixel_instance_map_list.shape)
#        (2, 5, 256, 256, 13)
#        (2, 20, 256, 256, 2)
#        (2, 20, 256, 256)
#        (2, 256, 256)
...
#        (2, 256, 256)
        ...
        for i in range(adj_seq_num):
            ...
            motion_cat_list.append(tmp_motion_cat) # (256, 256, 2) # static heatmap and moving heatmap (1/0)
